...
public class HTTPUtilsTests {
  ...
  public void HTTPRequestHeaderTest1() {
    ...
    assertEquals(HTTPRequestMethod.GET.toString(), hrh1.getRequestMethod());
  ...
  public void HTTPRequestHeaderTest2() {
    ...
    assertEquals(HTTPRequestMethod.POST.toString(), hrh1.getRequestMethod());
  }
  ...
  public void HTTPRequestHeaderTest4() {
    HTTPRequestHeader hrh1 = new HTTPRequestHeader(HTTPRequestMethod.DELETE, "/ds/sds/ds/", null, HTTPConstants.HTTP_VERSION_1_1);
    assertEquals(HTTPRequestMethod.DELETE.toString(), hrh1.getRequestMethod());
    assertEquals(HTTPConstants.HTTP_VERSION_1_1, hrh1.getHttpVersion());
    assertEquals("/ds/sds/ds/", hrh1.getRequestPath());
    assertEquals("DELETE /ds/sds/ds/ HTTP/1.1", hrh1.toString());
